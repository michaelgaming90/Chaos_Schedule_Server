...
{   
    ...
    Submit_Button.addEventListener("click", async () => 
    {
        ...
        try
        {
            let request = new Request(`https://chaos-schedule-application.onrender.com/login`, 
            {
                method: "PUT",
...
async function Create_An_Account(Page_Title, [Username_Input, Password_Input], Confirm_Password, Log_In_Container, Create_Account_Button)
{
    ...
    let request = new Request(`https://chaos-schedule-application.onrender.com/create_an_account`, 
    {
        method: "PUT",
        headers: {"Content-Type": "application/json"},
        body: JSON.stringify(Data)
